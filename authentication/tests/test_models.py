...
from foodnaut.authentication.models import Profile
from foodnaut.activities.models import Notification
...
class TestModels(TestCase):
    ...
    def setUp(self):
        ...
        self.profile.url = 'tryfoodnaut.vitorfs.com'
